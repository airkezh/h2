...
shareWX.bind({
	'link': 'http://' + location.host + '/zulilyOld/qa/6499',
...
$(".again_btn").on("click", function() {
	// content.$(content.document).trigger('start');
	// 	switchInterface('play');
	window.location.href = window.__get_r("http://mapp.meilishuo.com/zulilyOld/?hdtrc=desire_AppPush_0215_03", fml.vars.common_r);
});
