...
var controlFns = {
	'rank_tab' : function(){
		var mSelf = this
		    , php = {
		    	'bg_rank' : 'meidian::/bigger/get_top'
		    }
	...
	'my_list' : function(){
		var mSelf = this
		    , php = {
		    	'bg_my_list' : 'meidian::/bigger/get_list'
		    }
	...
	'test' : function(){
		var mSelf = this
		    , php = {
		    	'bg_user' : 'meidian::/auth/current_user'
		    }
	...
	'result' : function(){
		var mSelf = this
		    , php = {
		    	'bg_detail' : 'meidian::/bigger/get_detail',
		    	'bg_comments' : 'meidian::/bigger_comment/get_list',
		    	'bg_user' : 'meidian::/auth/current_user'
		    }
	...
	'mark' : function(){
		var mSelf = this
		    , php = {
		    	'bg_mark' : 'meidian::/bigger_comment/get_example',
		    	'bg_remind' : 'meidian::/bigger/get_detail',
				'bg_user' : 'meidian::/auth/current_user'
		    }
	...
	'retest' : function(){
		var mSelf = this
		    , php = {
		    	'bg_retest' : 'meidian::/bigger/get_detail'
		    }
