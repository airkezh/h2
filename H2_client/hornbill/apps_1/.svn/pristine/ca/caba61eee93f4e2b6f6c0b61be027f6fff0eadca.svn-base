...
var controlFns = {
	main : function(){
		...
		this.listenOver(function(data){
			...
			data.type = type;
			data.Tshow = Tshow;
			data._CSSLinks = ['page_guang' , 'huodong/meimei'];
			data.pageTitle = '美眉的战争';
			mSelf.render('biz/brand/meimei.html', data);
		});
	}
}
exports.__create = controller.__create(meimei, controlFns);
