...
var turntable = {
    ...
    initEvent: function(){
        ...
        // 点击抽奖
        $('body').on('click', '#pointer, #threshold', function(){
            var that = $(this);
    ...
    sendDrawAjax: function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                switch (code) {
                    case 0:
                        tracking.cr('member_turntable', {'area': 'luckdraw_button', 'isfree': 1, 'frm': curPageUrlFrmParam || 'turntable'});
    ...
    updateTurntablePointer: function(){
        ...
        if (curUserTotalBeans < fml.vars.turntableThreshold) {
            ...
            oThreshold.addClass('inactive');
        } else {
            oPointer.removeClass('inactive');
            oThreshold.removeClass('inactive');
        }
    },
