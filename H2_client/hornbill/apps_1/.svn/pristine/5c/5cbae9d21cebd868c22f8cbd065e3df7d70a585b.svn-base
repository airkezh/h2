...
var $           = require( 'wap/zepto' ),
    ...
    WX_SHARE_PIC         = 'http://d06.res.meilishuo.net/img/_o/33/bf/30a4a1c3bd5898f30f3215014c53_200_200.ch.jpg',
    WX_SHARE_TEXT        = '圣诞来美丽说 bibi噜(￣ε￣*) 1225 元现金券快到碗里来!',
    WX_SHARE_TEXT_SUC    = '美丽说 $ 元现金券顺利到手啦~内个 1225 元的红包等等我【尔康手',
    WX_SHARE_TEXT_FAIL   = '美丽说平安夜撒红包,瓜分2000万人人有份, 我居然...',
    WX_SHARE_URL         = 'http://' + LOCATION.host + '/wx/christmas2014/'
