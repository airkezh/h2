fml.define('m/app/login' , ['m/zepto/touch', 'component/storage', 'component/urlHandle', 'component/validate','component/shareTmp','app/checkcode'] , function(require , exports){
