fml.define('wap/page/sq/orderconfirm' , ['component/shareTmp','component/storage','wap/zepto/fastclick', 'wap/ui/alert','wap/app/dialog','wap/app/select','component/regString', 'wap/component/urlHandle', 'wap/app/tracking','component/callApi'] , function(require){
	...
	address_info = {}
	$.get('/aj/sq/address_info', {'normal' : 'false'} , function(data){
		if(data.ecode == 2007){
	...
	var Page = {
		...
		updateAddr: function(choose){
			...
			if( !!choose && choose != '' && choose == '1'){
				$.get('/aj/sq/address_info', {'normal' : 'true'} , function(data){
					var qq_info = data.data
					address.nickname = qq_info.name
					address.phone = qq_info.mobile
					address.city_code = qq_info.cityCode
