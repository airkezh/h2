fml.define('wap/app/doota/timedown',[] , function(require , exports){
	var heartBeatStack = {}
	var correct
	...
	exports.down = function (pnl, remains, format, formatUnit){
		...
		var time_start = new Date()
			,time_end  = new Date(time_start.getTime() + remains)
		...
		function init(){
			...
			// iphone 时间重算
			if (correct) remains = time_end - new Date()
			remains -= step
			pre_ret = ret
		}
		//init()
