...
return {
    createSelect : function(objs,callBack){
        ...
        function showSelect(obj){
	        ...
	        arr.push('<div class="select"><div class="selectText" val="'+ obj.find("option:selected").attr("id") +'" >'+ regString.escapeString(obj.find("option:selected").text()) +'</div><div class="selectBtn"></div></div>');
