...
fml.use('page/im/open' , function (){
	this.bind('.knilmi',{is_simple:!(Meilishuo.config.is_service)})
	})
...
fml.use(['jquery', 'component/iStorage', 'app/tracking'], function(){
	...
	$close.click(function(e) {
		$(this).parent().hide();
		storage.setCookie('tip_close' , new Date().getTime() ,{'duration' : 3*86400});
	});
...
fml.use(['jquery','component/shareTmp'], function(){
	...
	$.get('/aj/sale/bay_window', { }, function(data){
...
fml.define('page/common/global',[] ,function(){});
