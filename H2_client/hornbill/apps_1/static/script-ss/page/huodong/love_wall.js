...
fml.define('page/huodong/love_wall',['jquery','app/shareTo','ui/alert','app/dialogSuccess','app/twitterApi','component/regString','app/magazine','ui/dialog','component/shareTmp','app/checkLogin'],function(require){
	...
	function picForUpload(response){
		...
		$("#forwardMaga").unbind("click").bind("click" , function(){
			...
			if($("#forwardContent").val() != "写点什么,评论一下"){
				 content = '#520爱的告白# '+$("#forwardContent").val();
				}
						...
						if(data.code){
							...
							switch(data.success){
								case 1:
									a = new Alert({
										width:380,
										content:'<p>分享成功</p><p>恭喜您获得一张5元现金券&nbsp;&nbsp;<a class="red_f" href="/coupon/">查看&gt;&gt;</a></p>'
									});
									break;
								case 2:
									a = alert('分享成功');
	...
	var desc = "我在美丽说参加了《520爱的告白活动》，亲们快来帮我点个赞吧~";
	var title = "";
