...
$foot_bannar.hide()
addPoster('全部')
logTrack.cr('beauty_sale1111_pc', {'acid': fml.vars.acid, 'type': 'all', 'hdtrc': fml.vars.hdtrc});
...
$('.bs_tab_wrap div').on('click', function(){
	...
	logTrack.cr('beauty_sale1111_pc', {'acid': fml.vars.acid, 'type': data_name, 'hdtrc': fml.vars.hdtrc});
