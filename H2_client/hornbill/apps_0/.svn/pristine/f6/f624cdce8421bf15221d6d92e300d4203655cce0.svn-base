fml.define('wap/app/posterWalls2' , ['component/urlHandle' , 'wap/zepto', 'wap/component/windowScroll','wap/component/wapfall', 'wap/component/shareTmp'] , function(require , exports){
	...
	var ajaxPoster = function(url,extraparam){
	//	console.log('ajax f')
		isPosterLoad = false 
		pullUp.attr('status', 'loading');
		//param: extraparam是为了hack请求url增加参数或改变参数值的需求
		//wenjunwu add
		if(extraparam){
			$.extend(true, urlData , extraparam);
		}
