...
var $           = require( 'wap/zepto' ),
    ...
    picPicPublicPart = 'http://i.meilishuo.net/css/images/activity/danmu/springcoming/',
    images           = {
        'flower'     : { 'img' : picPicPublicPart + 'flower.png', 'width' : 54, 'height' : 54 },
        'heart'     : { 'img' : picPicPublicPart + 'redheart.png', 'width' : 51, 'height' : 43 },
        'money'    : [{ 'img' : picPicPublicPart + 'money.png', 'width' : 65, 'height' : 62 },{ 'img' : picPicPublicPart + 'money1.png', 'width' : 69, 'height' : 34 },{ 'img' : picPicPublicPart + 'money2.png', 'width' : 50, 'height' : 30 },{ 'img' : picPicPublicPart + 'money3.png', 'width' : 69, 'height' : 34 }],
        'cloud' : { 'img' : picPicPublicPart + 'cloud.png', 'width' : 55, 'height' : 30 },
        'sun'      : { 'img' : picPicPublicPart + 'sun.png', 'width' : 53, 'height' : 50 },
        'skirt'  : { 'img' : picPicPublicPart + 'skirt.png', 'width' : 46, 'height' : 54 },
        'star'    : { 'img' : picPicPublicPart + 'flower1.png', 'width' : 50, 'height' : 50},
        'pill'     : [{ 'img' : picPicPublicPart + 'pill.png','width' : 81, 'height' : 51},{ 'img' : picPicPublicPart + 'pill1.png','width' : 55, 'height' : 36},{ 'img' : picPicPublicPart + 'pill2.png','width' : 57, 'height' : 39},{ 'img' : picPicPublicPart + 'pill3.png','width' : 67, 'height' : 33},{ 'img' : picPicPublicPart + 'pill4.png','width' : 44, 'height' : 44}],
        'muscle'   : {'img' : picPicPublicPart + 'muscle.png','width' : 47, 'height' : 49}
    },
    keywords         = {
        'flower'     : ['花'],
        'heart'     : ['萌'],
    ...
    WX_SHARE_PIC         = 'http://i.meilishuo.net/css/images/activity/danmu/springcoming/sharepic.jpg',
    WX_SHARE_TEXT        = "你的“春天”来了吗？快来美丽说一句话证明，还可获得超优惠福利哦！",
    WX_SHARE_TEXT_SUC    = '美丽说 $ 到手~ 小伙伴们还不来拿福利，别怪我没有告诉你>ω<',
    WX_SHARE_TEXT_FAIL   = '伐开心 木有红包拿 含泪！小伙伴快去试试手气吧！',
    WX_SHARE_URL         = 'http://' + LOCATION.host + '/wx/springcoming/'
...
Panel.prototype = {
    ...
    show: function( type, id ) {
        ...
        if ( id ) {
            title = '哇 中了' + lotteryData.awards[ id ].awardname + '!'
     ...
     function keywordDetector(msg){
        ...
        if(flag){
            ...
            if(imgData.length){
                ...
                widths = [],
                heights = [];
                imgData.forEach(function(val){
                    imgs.push(val.img);
                    widths.push(val.width);
