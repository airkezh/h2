fml.define('meidian/app/posterWalls' ,['wap/zepto/touch', 'wap/component/windowScroll','meidian/app/waterfall', 'wap/component/shareTmp'] , function(require , exports){
	var shareTmp = require('wap/component/shareTmp');
	var scroll = require('wap/component/windowScroll');
	var pin = require('meidian/app/waterfall');
	var pullUp = $('.pullUp')
		, win = $(window)
		, win_h = win.height()
		, win_w = win.width()
