fml.define('order_app/common/component/uploadBtn', ['order_app/common/zepto', 'order_app/common/zepto/touch',
    'order_app/common/app/tracking'], function (require, exports) {
    var tracking = require('order_app/common/app/tracking');
