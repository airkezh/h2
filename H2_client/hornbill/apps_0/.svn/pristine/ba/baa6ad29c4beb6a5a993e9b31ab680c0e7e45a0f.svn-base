...
var controlFns = {
	...
	'run' : function(){
		...
		this.listenOver(function(data){
			...
			data.pageTitle = '疯狂购物车';
			data._CSSLinks = ['lark/run'];
		this.render('lark/run.html', data);
		});
	},
	'tooth' : function(){
		var mSelf = this
		...
		this.listenOver(function(data){
			...
			data.pageTitle = '鳄鱼拔牙游戏';
			data._CSSLinks = ['lark/tooth'];
		this.render('lark/tooth.html', data);
		});
	},
	'skip' : function(){
		var mSelf = this
		...
		this.listenOver(function(data){
			...
			data.pageTitle = '跳绳';
			data._CSSLinks = ['lark/skip'];
		this.render('lark/skip.html', data);
		});
	}
};
