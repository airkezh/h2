fml.define('app/search' , ['jquery','component/regString' , 'component/shareTmp' , 'component/urlHandle','component/cursorPostion'] , function(require , exports){
	...
	function init(){
		...
		$('.ipt2').on( 'click' , function(){
			...
			var searchName = 'searchshop';
			if(sugg.getType()  == GOODS){
				searchName = 'searchgoods';
			}
			var value = searchName+'='+searchValue;
			$search.val(encodeURIComponent(value))
		})
	}
	return {
		init : function(){
