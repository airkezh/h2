fml.define('app/doota/stock',['jquery'] , function(require , exports ){
	var _notype =false
	var _o = function(opt){
		var self = this
		this.opt = opt
		this.stockMax = null
		this.maxOrderNum = opt.maxOrderNum ? opt.maxOrderNum : 100
	...
	_o.prototype.updateNum =  function(num , limitMax){
		...
		var maxOrderNum = this.maxOrderNum
