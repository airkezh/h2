fml.define('m/app/doota/address' , ['m/zepto/touch', 'm/ui/filterSelecter','m/component/callApi', 'component/validate', 'component/shareTmp'] , function(require , exports){
	...
	var renderProvince = function(cb){
		callApi.read({'url':'/address/addr_select'},function(data){
			var html = shareTmp('address_select_province',data.data);
			$('#addressPid').append(html);
		});
	}
