...
fml.define('component/imgAreaSelect', ['jquery'], function(require, exports) {
    ...
    $.imgAreaSelect = function(img, options) {
        ...
        function update(resetKeyPress) {
            ...
            if(resetKeyPress !== false) {
                ...
                if(options.keys) $(document)[$.imgAreaSelect.keyPress](
        ...
        $img.is('img') ? $img.one('load', imgLoad) : imgLoad();
    ...
    return function(obj, options) {
        ...
        if($(obj).data('imgAreaSelect')) {
            if(options.remove) {
                $(obj).data('imgAreaSelect').remove();
                $(obj).removeData('imgAreaSelect');
            } else $(obj).data('imgAreaSelect').setOptions(options);
        } else if(!options.remove) {
            if(options.enable === undefined && options.disable === undefined) options.enable = true;

            $(obj).data('imgAreaSelect', new $.imgAreaSelect(obj, options));
        }
        if(options.instance) return $(obj).data('imgAreaSelect');
    };
