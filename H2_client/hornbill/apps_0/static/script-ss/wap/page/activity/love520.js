fml.define('wap/page/activity/love520' , ['wap/zepto/touch', 'wap/app/dialog', 'wap/component/shareTmp'] , function(require , exports){
	...
	$('.share').on('tap', function(){
		/*版本判断*/
		if (!fml.vars.isApp){
			var href = '/activity/sale/love/';
			window.location.href = 'http://m.meilishuo.com/goto/open/?appUrl='+encodeURIComponent(href)
