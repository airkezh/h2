...
var uniquePlugin    = require('circle/component/waterfallDataUniquePlugin')
...
$tab.on('click', function (){
	...
	history.replaceState(null,title,'/sq/search/?' + urlHandle.http_build_query(params))
	switchWaterfall()
})
