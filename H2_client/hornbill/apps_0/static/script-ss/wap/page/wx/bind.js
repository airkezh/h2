fml.define('wap/page/wx/bind' , ['wap/zepto/touch', 'wap/app/forminput', 'wap/app/checkcode', 'component/urlHandle', 'wap/ui/alert'] , function(require){
		...
		var callback = function(r){
			...
			if(r.err_code) {
				...
				var a =  new Alert({
					content : '绑定成功'
					, onClose : function(){
						urlHandle.redirect('/wx/myaccount/');
					}
				});
			}	
		}
