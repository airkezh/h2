...
var urlHandle = require("wap/component/urlHandle");
	...
	var changeBind = function(){
		var $message = $(".bindErrorMessage"),
			$button = $(this),
			url = '/user/aj/sendcode/changeBind',
			data = {
				'mobile': $.trim($mobile.val()),
				'captcha': $.trim($code.val()),
