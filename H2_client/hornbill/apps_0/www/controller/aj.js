...
var controlFns = {
    ...
    huodong: function (params) {
        ...
        var php = {
            ...
            'xuanwuqiji_ti':'/customactivity/CustomActivity_create_xuanwu',
            'xuanwuqiji_rank':'/customactivity/CustomActivity_xuanwu_photo_rank',
            'xuanwuqiji_vote':'/customactivity/CustomActivity_xuanwu_photo_vote',
            'qqxuanwu_addtopic':'/huodong/QQXuanwu_addtopic',
            'qqxuanwu_vote':'/huodong/QQXuanwu_Ballot',
            'oppo_draw':'vip::/award/draw',
			'oppo_saveInfo':'vip::/award/saveContactInfo',
...
//            //人工查看
    ...
    shop: function (params) {
        var php = {
            ...
            , 'shop_validate':'/shop/shop_validate'
        }
        this.ajaxTo(php[params])
    },
    ...
    hd_dongfeng: function (params) {
        var php = {
            ...
            'addNewVote':'/huodong/Dongfeng_Ballot2'
        }
        this.ajaxTo(php[params])
    },
    ...
    'interconnect': function(params) {
        ...
        var php = {
            ...
            'sendCode' : '/register/register_send_sm_captcha'
            //'sendCode' : '/user/reg/send_sm_captcha'
        };
        this.ajaxTo( php[params] )
    },
    reportGoods : function(params){
        // this.debugSnake({'target':'shenyang.rdlab'});
        var php = {
            'report_info' : '/risk/risk_post_report_info',
            'reply' : '/risk/risk_get_user_reply?id=151',
            'update' : '/risk/risk_post_update_report'
        }
    ...
    'pc_mob': function(params){
        ...
        var php = {
            'show_win' : '/newcomer/get_activity_mobile_limit_status',
            'apply' : '/newcomer/activity_pctomob_apply',
            'resend_msg' : '/newcomer/activity_pctomob_sms',
            'close_long' : '/newcomer/set_page_display'
        }
        this.ajaxTo(php[params])
    },
    ...
    member: function(params){
        //this.debugSnake({'target':'zhaolongjiang.rdlab'});
        var php = {
            'getBeautyList': 'vip::/vip/getPcBeautyDetail',
            'getBeansList': 'doota::/coin/get_list_beans_pc'
        };
