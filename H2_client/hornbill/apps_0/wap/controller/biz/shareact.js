...
var controlFns = {
	new_home : function(){
		var mSelf = this;
		var anchor  =  this.req.__get.anchor ? this.req.__get.anchor : '';
		var php = {
	...
	new_efficacy : function(params){
		...
		var php = {
			...
			'search':'/customactivity/CustomActivity_common_tool_single?id=mz_search'
		}
		this.setMDefault(php);
		this.bridgeMuch(php);
		this.listenOver(function(data){
	...
	voice : function(){
		...
		this.listenOver(function(data){
			...
			data._CSSLinks = ["biz/beauty_sale/voice"];
			mSelf.render("biz/beauty_sale/voice.html", data);
		});
	}
};
