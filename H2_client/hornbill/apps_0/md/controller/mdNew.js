...
var controlFns = {
	index : function(args){
		args = (args in controlFns) ? args  : 'homeNew'
		this[args]()
	},
	'homeNew' : function(args){
	...
	'orderConf' : function(){
		...
		this.listenOver(function(data){
			...
			if (data.order.code != 0) {
				return this.render('errorPage.html',data)
			}
			//console.log(data)
			...
			data._CSSLinks = ['md/orderNew'];
			this.render('orderConf.html', data);
		});
	},
	'payCBK' : function(){
		var mSelf = this
		...
		this.bridgeMuch(php);
		this.listenOver(function(data){
			this.redirectTo('/md/success?order_id=' + this.req.__get.order_id, false)
		});
	},
	'weixinCBK' : function(args){
		...
		this.bridgeMuch(php);
		this.listenOver(function(data){
			return this.redirectTo('/md/' + args ,true);
		});
	},
	'prohibit' : function(){
		var mSelf = this
		...
		this.listenOver(function(data){
			...
			this.render('prohibit.html' ,data);
		});
	},
	'agreement' :  function(){
		var mSelf = this
		...
		this.listenOver(function(data){
			...
			data._CSSLinks = ['md/md'];
			this.render('agreement.html' ,data);
		});
	},
	'success' : function(){
		var mSelf = this;
	...
	'treasure' : function(){
		...
		this.listenOver(function(data){
			...
			this.render('treasure.html', data);
		});
	},
	'md_chan' : function(){
		var mSelf = this
	...
	'orderDetail' : function(){
		...
		this.listenOver(function(data){
			...
			this.render('orderDetail.html' , data);
		});
	},
	'orderList' : function(){
		var mSelf = this;
	...
	'mdWlcome' : function(){
		...
		this.listenOver(function(data){
			...
			this.render('mdWlcome.html' , data);
		});
	}
}
...
exports.__create = controller.__create(mdNew , controlFns);
